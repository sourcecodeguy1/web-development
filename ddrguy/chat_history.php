		...
		require("./connect.php");
				...
				<div id='right2'>
				  ...
				  <div class='cornersfg'>
					...
					$query = mysql_query("SELECT * FROM profile_comments WHERE profile_id='".$userid."' ORDER BY id DESC");
					...
					////////////////////////************Sent Messages********************//////////////////
						...
						$query2 = mysql_query("SELECT * FROM profile_comments WHERE user_id='".$userid."' ORDER BY id DESC");
						...
						if ($numrows2 > 0){
							...
							$date2 = $row2['date'];
							echo "<b>Posted for: <a href='$site/profile?id=$profile_id2'>$profile_user2</a> on $date2</b><br />";
